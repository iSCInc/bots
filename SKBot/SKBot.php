...
define('SERVER','http://suriyaakudo.bplaced.net');
...
if (file_exists('SKBot.php'))
	require_once('SKBot.php');
// ELSE you need to fill out the next few settings.
if (!defined('USERID')){	define('USERID','1');} // find it at Special:Preferences
if (!defined('USERNAME')){	define('USERNAME','SKBot');}
if (!defined('PASSWORD')){	define('PASSWORD','suriyaa4');} // password in plain text. No md5 or anything.
